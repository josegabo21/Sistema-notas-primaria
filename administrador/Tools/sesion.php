                ...
                <a href="./option_profe.php">
                 <button href="administrador/Tools/option_profe"  class="select" id="usuarioProfe" value="Usuario">Profesor</button>
                    ...
                    <div class="form" id="admin" >
                        <form id="formAdmin"  action="" method="POST" onsubmit="return validar()">
                            <h2>Administrador</h2>
                        
                            <?php
                            require './administrador/Tools/conexion.php';
                            require './administrador/Tools/loginAdmin.php';
                            ...
                            <input type="submit" id="loginProfesor" name="btningresar_admin" value="INICIAR SESION">
                        </form>
                    </div>
