...
require_once  './grados/registro_4toGrado.php';
require_once './grados/eliminar_usuario4toGrado.php';
...
<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="bi bi-table"></i> Lista de estudiantes 4to Grado </h1>
        
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="bi bi-house-door fs-6"></i></li>
          <li class="breadcrumb-item"><a href="4to_grado.php">Lista de estudiantes 4to Grado</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="tile-body">
              <div class="table-responsive">
                ...
                onclick="ModificarUsuario_4toGrado()">Nuevo Estudiante</button>
                  ...
                  <tbody>
                    <?php
                      $sql= " SELECT * FROM estudiantes_cuartoGrado ";
